...
export const ui = {
  zh: {
    nav: [
      ...
      { path: '/apply', label: '準備出發', short: '準備出發' },
  ...
  ja: {
    nav: [
      ...
      { path: '/apply', label: '出発準備', short: '出発準備' },
  ...
  en: {
    nav: [
      ...
      { path: '/apply', label: 'Getting Ready', short: 'Ready' },
    ...
    footerLinks: [
      ...
      { path: '/apply', label: 'Getting Ready' },
