...
export const ui = {
  zh: {
    nav: [
      ...
      { path: '/apply', label: '資料提交', short: '資料提交' },
  ...
  ja: {
    nav: [
      ...
      { path: '/apply', label: 'プロフィール送信', short: '送信' },
  ...
  en: {
    nav: [
      ...
      { path: '/apply', label: 'Submit Profile', short: 'Profile' },
    ...
    footerLinks: [
      ...
      { path: '/apply', label: 'Submit Profile' },
